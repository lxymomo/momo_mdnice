...
function buildTheme({
  ...
  return {
    ...
    pStyle: `margin:0 0 22px !important;white-space:normal;padding:0 !important;box-sizing:border-box;line-height:${lh} !important;letter-spacing:${ls};font-size:15px;`,
    sectionStyle: `padding:0 !important;margin:0 !important;box-sizing:border-box;font-size:15px;`,

    renderTopHeader(coverBase64) {
      const imgSrc = coverBase64 || 'assets/cover-bg.png';
      return `
      <section style="display:flex;flex-flow:row;margin:14px 0 20px 0;box-sizing:border-box;">
      ...
      <section style="text-align:center;margin:0 0 28px 0;box-sizing:border-box;">
    ...
    renderTitle(title) {
      return `
      <section style="margin:20px 0 30px 0;box-sizing:border-box;">
    ...
    renderH1(num, title) {
      ...
      return `
      <section style="margin:56px 0 8px 0;box-sizing:border-box;">
    ...
    renderH2(title) {
      return `
      <section style="margin:36px 0 10px 0;box-sizing:border-box;">
    ...
    renderH3(title) {
      return `
      <section style="margin:26px 0 8px 0;box-sizing:border-box;">
    ...
    renderQuote(linesHtml) {
      return `
      <section style="margin:16px 0 36px 0;padding:0 0 0 16px;box-sizing:border-box;">
    ...
    renderList(items) {
      const rows = items.map(text => `
        <section style="display:flex;align-items:flex-start;padding:10px 0;box-sizing:border-box;border-bottom:1px solid rgba(0,0,0,0.06);">
      ...
      return `
      <section style="margin:6px 0 24px 0;background-color:${listBg};border-radius:4px;overflow:hidden;box-sizing:border-box;padding:0 12px;">
        ${rows}
      </section>`;
    },
    ...
    renderCard(innerHtml) {
      const logoImg = (this.cardLogoUrl && this.cardLogoUrl !== 'YOUR_PNG_LOGO_URL_HERE')
        ...
        : '';
      return `
      <section style="margin:20px 0;background-color:${cardBg};padding:18px 16px;border-radius:8px;box-sizing:border-box;">
    ...
    renderRef(innerHtml) {
      return `
      <section style="margin:48px 0 24px 0;box-sizing:border-box;">
    ...
    renderFooter() {
      if (footerStyle === 'text') {
        return `
        <section style="text-align:center;margin:60px 0 20px 0;box-sizing:border-box;">
        ...
        <section style="text-align:center;margin:16px 0 32px 0;font-size:10px;color:${accent};letter-spacing:4px;opacity:0.35;">
      ...
      return `
      <section style="text-align:right;margin:40px 0 10px 0;box-sizing:border-box;">
